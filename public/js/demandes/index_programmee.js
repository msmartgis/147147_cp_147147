$(document).ready(function () {
    ...
    $('#communes_filter_programmee,#intervention_filter_programmee,#partenaires_filter_programmee,#localites_filter_programmee,#reservation_programmee').on('change paste keyup', function (e) {
