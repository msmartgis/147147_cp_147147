<div id="drawerExample" class="drawer dw-xs-5 dw-sm-3 dw-md-3 fold " aria-labelledby="drawerExample" style="height: 84.75%; margin-top: 6.75%;">
    <div class="drawer-controls" style="margin-top: 50%;">
