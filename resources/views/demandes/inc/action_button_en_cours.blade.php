...
<div class="row" style="margin-top: 4px">
    ...
    <div class="col-lg-6">
        ...
        <a href="" class="btn btn-secondary pull-left" style="margin-right : 6px ;background-color: #5c7ec4 !important;border-color: #5c7ec4 !important;"><i class="fa fa-print" style="margin-right: 6px "></i>Accord definitif</a>

        <a href="" class="btn btn-secondary pull-left" style="margin-right : 6px ;background-color: #9fd037 !important;border-color: #9fd037 !important;"><i class="fa fa-print" style="margin-right: 6px"></i>Affecter aux conventions</a>
