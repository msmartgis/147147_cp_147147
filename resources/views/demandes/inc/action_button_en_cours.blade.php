...
<div class="row" style="margin-top: 4px">
    ...
    <div class="col-lg-6">
        ...
        <button type="button" class="btn btn-secondary pull-left" id="a_traiter_btn" style="margin-right : 6px"><i class="fa fa-print" style="margin-right: 6px"></i>A traiter </button>
        <button type="button" class="btn btn-secondary pull-left" id="accord_definitif_btn" style="margin-right : 6px ;background-color: #F2922A !important;border-color: #F2922A !important;"><i class="fa fa-print" style="margin-right: 6px "></i>Accord definitif</button>
