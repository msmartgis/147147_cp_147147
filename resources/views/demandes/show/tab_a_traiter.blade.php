<div class="tab-pane pad" id="a_traiter_tab" role="tabpanel">
            ...
            <div class="dropdown" style="margin-left : 8px">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item " href="#">
                        <div id="modifier_a_traiter"><i class="fa fa-edit"></i> Modifier</div>
                    </a>
                    <a class="dropdown-item" href="#">
                        <div id="restaurer_a_traiter"><i class="fa fa-thumbs-up"></i> Restaurer</div>
                    </a>
