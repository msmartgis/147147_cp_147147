<div class="tab-pane pad" id="programmee_tab" role="tabpanel">
        ...
        <div class="dropdown" style="margin-left : 8px">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item " href="#">
                    <div id="modifier_programmee"><i class="fa fa-edit"></i> Modifier</div>
                </a>
                <a class="dropdown-item" href="#">
                    <div id="restaurer_programmee"><i class="fa fa-thumbs-up"></i> Restaurer</div>
                </a>
            </div>
        </div>
    </div>
